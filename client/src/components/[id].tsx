...
export const NotePage = () => {
  ...
  return (
    <div className="flex flex-col bg-[#1A120B]">
      <NavBar />
      <div className="h-screen bg-[#1A120B] flex flex-col justify-between">
        ...
        <div className="items-center text-center">
          <p className="text-[#D5CEA3] text-lg opacity-60 py-10 font-bold italic">
