            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#3C2A21] outline-none focus:outline-none">
                ...
                <div className="flex flex-col gap-2 mx-4 items-center">
                  <input className="bg-[#D5CEA3] focus:outline-none text-[#1A120B] w-52 font-bold px-1 py-2 rounded-md"></input>
                  <textarea className="bg-[#D5CEA3] focus:outline-none text-[#1A120B] w-52 h-52 font-bold px-1 py-2 resize-none rounded-md"></textarea>
                </div>
